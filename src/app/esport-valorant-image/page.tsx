...
export default function EsportValorantImagePage() {
  return (
      ...
      <div className="w-full px-4 md:px-12 lg:px-20 py-8 md:py-12 flex-grow">
        ...
        <RevealUp delay={0.1} duration={0.8}>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mt-8 pb-4 border-b border-[#333333]">
            <h1 className="text-4xl md:text-5xl font-light tracking-wide text-left">Zine</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-4">
          ...
          {/* Item 2 */}
          <RevealUp delay={0.6} duration={0.8}>
            <div className="flex flex-col gap-4">
              <div className="relative w-full aspect-video overflow-hidden rounded-xl bg-[#1A1C20]">
                <Image
                  src="/yep-02.png" 
          ...
          {/* Item 3 */}
          <RevealUp delay={0.7} duration={0.8}>
            <div className="flex flex-col gap-4">
              <div className="relative w-full aspect-video overflow-hidden rounded-xl bg-[#1A1C20]">
                <Image
                  src="/yep-03.png" 
          ...
          {/* Item 4 */}
          <RevealUp delay={0.8} duration={0.8}>
            <div className="flex flex-col gap-4">
              <div className="relative w-full aspect-video overflow-hidden rounded-xl bg-[#1A1C20]">
                <Image
                  src="/mock3 (1).jpg" 
